		...
		<form method="post" enctype="multipart/form-data" id="tutor-registration-form">
				...
				<div class="tutor-form-col-6">
					<div class="tutor-form-group">
						...
						<input type="text" name="first_name"
							...
							placeholder="<?php esc_attr_e('First Name', 'tutor'); ?>" required autocomplete="given-name">
					</div>
				</div>
				...
				<div class="tutor-form-col-6">
					<div class="tutor-form-group">
						...
						<input type="text" name="last_name"
							...
							placeholder="<?php esc_attr_e('Last Name', 'tutor'); ?>" required autocomplete="family-name">
					</div>
				</div>
				...
				<div class="tutor-form-col-6">
					<div class="tutor-form-group">
						...
						<input type="text" name="user_login" class="tutor_user_name"
							...
							placeholder="<?php esc_html_e('User Name', 'tutor'); ?>" required autocomplete="username">
					</div>
				</div>
				...
				<div class="tutor-form-col-6">
					<div class="tutor-form-group">
						...
						<input type="text" name="email"
							...
							placeholder="<?php esc_html_e('E-Mail', 'tutor'); ?>" required autocomplete="email">
					</div>
				</div>
						...
						<div class="tutor-password-strength-checker">
							<div class="tutor-password-field">
								...
								<input class="password-checker" id="tutor-new-password" type="password" name="password"
									...
									placeholder="<?php esc_html_e('Password', 'tutor'); ?>" required
					...
					<div class="tutor-form-group">
						...
						<div class="tutor-form-wrap">
							...
							<input type="password" name="password_confirmation"
								...
								placeholder="<?php esc_html_e('Password Confirmation', 'tutor'); ?>" required
								autocomplete="new-password" style="margin-bottom: 0;">
						</div>
					</div>
				</div>
			...
			<?php if (null !== $tutor_toc_page_link): ?>
				<div class="tutor-mb-24">
					<?php esc_html_e('By signing up, I agree with the website\'s', 'tutor'); ?> <a target="_blank"
						href="<?php echo esc_url($tutor_toc_page_link); ?>"
						title="<?php esc_html_e('Terms and Conditions', 'tutor'); ?>"><?php esc_html_e('Terms and Conditions', 'tutor'); ?></a>
				</div>
			<?php endif; ?>

			<div>
				<button type="submit" name="tutor_register_student_btn" value="register"
					class="tutor-btn tutor-btn-primary tutor-btn-block"><?php esc_html_e('Register', 'tutor'); ?></button>
			</div>
